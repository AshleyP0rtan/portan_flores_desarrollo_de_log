...
<html lang="es-SV">
    <head>
        <title>INICIO DE SESION: ASHLEY MICHELLE PORTAN FLORES </title>
        <meta charset="UTF=8">
...
<div class="form-group col-md-5 ml-4 mr-4 justify-content-center align-self-center">
    <h1>Diseñando Estrategias para la Recuperacion y Migracion de Base de Datos (RBK0)</h1>
    <form name="frm_iniciar_sesion" id="frm_iniciar_sesion" action="core/process.php" method="post">
        <div class=form-group>
            ...
            <input type="text" class="form-control" id="txt_user" name="txt_user" aria-describedby="txt_userHelp" maxlenght="10" required>
...
<div class="form-group">
    ...
    <input type="password" class="form-control" id="txt_pass" aria-describedby="txt_passHelp" maxlenght="10" required>
    <small id="txt_passHelp" class="form-text text muted">La contraseña es obligatoria.</small>
</div>
<button type="submit" id="btn_ingresar" class="btn btn-primary mx-auto d-block" value="ingresar">Iniciar Sesion</button> </fomr>
</div>
</div>
